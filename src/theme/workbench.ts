...
return {
  ...
  'editor.findMatchHighlightBackground': withOpacity(t.decorative.findHighlightPigment, alphaEditor.findHighlightBg),
  'editor.findMatchHighlightBorder': withOpacity(t.decorative.findHighlightPigment, alphaEditor.findHighlightBorder),
  ...
  'editorGutter.addedBackground': withOpacity(t.git.gutterAdded.hex, op.solid),
  'editorGutter.modifiedBackground': withOpacity(t.git.gutterModified.hex, op.solid),
  'editorGutter.deletedBackground': withOpacity(t.git.gutterDeleted.hex, op.solid),
  'editorGutter.addedSecondaryBackground': withOpacity(t.git.gutterAdded.hex, op.strong),
  'editorGutter.modifiedSecondaryBackground': withOpacity(t.git.gutterModified.hex, op.strong),
  'editorGutter.deletedSecondaryBackground': withOpacity(t.git.gutterDeleted.hex, op.strong),
  ...
  'minimapGutter.addedBackground': t.git.gutterAdded.hex,
  'minimapGutter.modifiedBackground': t.git.gutterModified.hex,
  'minimapGutter.deletedBackground': t.git.gutterDeleted.hex,
  ...
  'testing.iconQueued': semantic.info,
