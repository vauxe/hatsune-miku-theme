...
export function createHelixTheme(t: SemanticTokens): string {
  ...
  const entries: Record<string, Style> = {
    ...
    'ui.bufferline': { fg: ui.foregroundMuted.hex, bg: houseBg },
    'ui.bufferline.active': { fg: fg, bg: bg, modifiers: ['bold'] },
    'ui.bufferline.background': { bg: houseBg },
    'ui.popup': { fg: fg, bg: floatBg },
    'ui.popup.info': { fg: fg, bg: floatBg },
    'ui.window': { fg: ui.border.hex },
    'ui.help': { fg: fg, bg: floatBg },
    'ui.text': { fg: fg },
    ...
    'ui.menu': { fg: fg, bg: floatBg },
    'ui.menu.selected': { fg: fg, bg: selBg },
