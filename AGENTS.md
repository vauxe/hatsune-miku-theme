...
- `--hm-*` plus `data-hm-theme="light"`, `"dark"`, `"snow-2024"`, and `"mm-2025"` are public. The absent attribute keeps the system-selected flagship behavior. `WEB_THEME_CUSTOM_PROPERTIES` locks names; renames or removals require migration.
